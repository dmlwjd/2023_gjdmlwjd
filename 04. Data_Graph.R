...
pie(table(KOTRA2023$투자형태),col=color, main="해외진출기업의 투자형태")
...
#팔레트 사용111
pal1<-brewer.pal(5,"Set3")
pie(table(KOTRA2023 $투자형태),col=pal1, mian="해외진출기업의 투자형태")

#축이름 표시
barplot(table(KOTRA2023 $투자형태),col=pal1,xlab="진출대륙명",ylab= "진출기업수",ylim=c(0,10000))
